...
describe OmniAuth::Strategies::Polaris do
  let!(:app) do
    Rack::Builder.new do |b|
      ...
      b.use OmniAuth::Strategies::Polaris, :name => 'polaris', :title => 'MyPolaris Form', :http_uri => 'http://blah.org/PAPIService/REST/public/v1/1000/100/1/patron/', :access_key => 'F9998888-A000-1111-C22C-CC3333BB4444', :access_id => 'API', :method => 'GET'
      b.run lambda { |env| [404, { 'Content-Type' => 'text/plain' }, [env.key?('omniauth.auth').to_s]] }
    end.to_app
  end
